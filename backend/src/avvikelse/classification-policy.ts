...
export const resolveIafVofInvestigationClassificationPolicy = (
  ...
  const policy: IafVofInvestigationClassificationPolicy = {
    ...
    preservesOwnerParameters: preservesIafVofInvestigationClassificationOwnerParameter,
    assertClassificationContext: (errand, documentKey, value, classification) =>
      assertSupportInvestigationClassificationContext(
        policy,
        resolveIafVofInvestigationClassificationOwner(policy, errand),
        documentKey,
        value,
        classification,
      ),
