...
export const invoiceData2026: {
  ...
  invoiceTypes: [
        ...
        invoiceRows: [
          {
            ...
            accountInformationRows: [
              { amountFromParent: false, amount: 310 },
        ...
        invoiceRows: [
          {
            ...
            main: true,
            accountInformationRows: [
              { amountFromParent: false, amount: 1550 },
              { amountFromParent: false, amount: 31, project: '11041' },
            ],
          },
        ],
        accountInformation: {
        ...
        invoiceRows: [
          {
            ...
            main: true,
            accountInformationRows: [
              { amountFromParent: false, amount: 360 },
    ...
    {
      invoiceType: 'Manuellt måltidsavdrag',
      fixedPrice: true,
      internal: {
        invoiceRows: [
          {
