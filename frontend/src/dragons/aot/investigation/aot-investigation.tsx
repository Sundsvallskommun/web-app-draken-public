...
import { defaultBasicsPlacement } from '../../../supportmanagement/investigation/classification-placement';
import type { InvestigationModule } from '../../../supportmanagement/investigation/investigation-module';
 ...
 */
export const aotInvestigation: InvestigationModule = Object.freeze({
  id: 'aot',
  label: 'Utredning',
