...
export enum FTApplicationCaseType {
  ...
  PARATRANSIT_CHANGE = FTCaseType.PARATRANSIT_CHANGE,
  PARATRANSIT_RENEWAL = FTCaseType.PARATRANSIT_RENEWAL,
  PARATRANSIT_NATIONAL = FTCaseType.PARATRANSIT_NATIONAL,
  PARATRANSIT_NATIONAL_RENEWAL = FTCaseType.PARATRANSIT_NATIONAL_RENEWAL,
...
export enum FTNotificationCaseType {
  ...
  PARATRANSIT_NOTIFICATION_NATIONAL_RENEWAL = FTCaseType.PARATRANSIT_NOTIFICATION_NATIONAL_RENEWAL,
