...
export const notificationChange_UppgiftFieldTemplate: UppgiftField[] = [
  {
    ...
    value: '',
    label: 'Beskriv de förändrade förutsättningar',
  ...
  {
    field: 'external.changedSupportDescription',
    value: '',
    label: 'Beskriv vilka insatser som behöver förändras',
    formField: {
      type: 'textarea',
    },
    section: 'Yttre omständigheter',
  ...
  {
    field: 'personal.changedDisabilityDescription',
    value: '',
    label: 'Beskriv förändringar i funktionsnedsättningen',
    formField: {
      type: 'textarea',
    },
