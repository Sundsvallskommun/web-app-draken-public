  ...
  data: {
    ...
    stakeholders: [
      ...
      },
      {
        ...
        personalNumber: mockEnv.mockPersonNumber,
      },
    ],
    facilities: [],
    decisions: [
    ...
    notes: [
      {
        ...
        updatedBy: mockEnv.mockAdUsername,
      },
      {
        id: 31,
        version: 9,
  ...
  stakeholders: [
    {
      ...
      contactInformation: [
        { contactType: 'PHONE', value: mockEnv.mockPhoneNumber },
        { contactType: 'EMAIL', value: mockEnv.mockEmail },
      ],
      personalNumber: mockEnv.mockPersonNumber,
    },
    {
