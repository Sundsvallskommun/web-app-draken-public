...
// Deliberately lines up with the first event in mockSupportHistory (same subtype, same timestamp) so
// the errand log can resolve which event a notification came from. Once upstream puts an eventId on
// notifications this can point at the event directly instead.
...
export const mockAcknowledgeResult = {
  acknowledged: ['bb893d57-04e9-44af-a271-aff5df530bba', 'bb893d57-04e9-44af-a271-aff5df530cca'],
  failed: [],
};
