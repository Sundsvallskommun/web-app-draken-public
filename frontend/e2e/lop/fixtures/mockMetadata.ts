  ...
  labels: {
      labelStructure: [
        ...
        },
        {
          ...
          classification: 'CATEGORY',
          displayName: 'Utgangen verksamhet',
          resourcePath: 'DEPRECATED_CATEGORY',
          resourceName: 'DEPRECATED_CATEGORY_NAME',
          deprecated: true,
          labels: [
            {
              id: 'd1000000-0000-4000-8000-000000000002',
              classification: 'TYPE',
              displayName: 'Typ under utgangen verksamhet',
              resourcePath: 'DEPRECATED_CATEGORY/CHILD_OF_DEPRECATED',
        ...
        },
        {
          ...
          classification: 'CATEGORY',
          displayName: 'Utgangstest',
          resourcePath: 'DEPRECATION_TEST',
          resourceName: 'DEPRECATION_TEST_NAME',
          labels: [
            {
              id: 'd2000000-0000-4000-8000-000000000002',
              classification: 'TYPE',
              displayName: 'Aktiv typ',
              resourcePath: 'DEPRECATION_TEST/ACTIVE_TYPE',
              resourceName: 'ACTIVE_TYPE_NAME',
              labels: [],
            },
            {
              id: 'd2000000-0000-4000-8000-000000000003',
              classification: 'TYPE',
              displayName: 'Utgangen typ',
            ...
            },
            {
              ...
              classification: 'TYPE',
              displayName: 'Typ med bara utgangna undertyper',
              resourcePath: 'DEPRECATION_TEST/EMPTIED_TYPE',
              resourceName: 'EMPTIED_TYPE_NAME',
              labels: [
                {
                  id: 'd2000000-0000-4000-8000-000000000005',
                  classification: 'SUBTYPE',
                  displayName: 'Utgangen undertyp',
                  resourcePath: 'DEPRECATION_TEST/EMPTIED_TYPE/DEPRECATED_SUBTYPE',
                  resourceName: 'DEPRECATED_SUBTYPE_NAME',
                  deprecated: true,
                  labels: [],
                },
              ],
